...
export default function Header({ onAddMovieClick, onAddActorClick }) {
  ...
  return (
    <div className="flex item-center justify-between relative p-5">
...
const CreateOptions = ({ options, visible, onClose }) => {
  ...
  return (
    <div
      ref={container}
      id={containerID}
      className="absolute right-3 top-16 z-50 flex flex-col space-y-3 p-5 dark:bg-secondary bg-white drop-shadow-lg rounded animate-scale"
